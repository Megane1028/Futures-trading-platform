...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-type" data-rule="required" class="form-control selectpicker" name="row[type]">
                <option value="1" <?php if(in_array((1), is_array($row['type'])?$row['type']:explode(',',$row['type']))): ?>selected<?php endif; ?>>公告</option>
                <option value="2" <?php if(in_array((2), is_array($row['type'])?$row['type']:explode(',',$row['type']))): ?>selected<?php endif; ?>>帮助中心</option>
            </select>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Short_content'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-short_content" class="form-control" name="row[short_content]" type="text" value="<?php echo htmlentities($row['short_content']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Rank'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-rank" class="form-control" name="row[rank]" type="number" value="<?php echo htmlentities($row['rank']); ?>">
        </div>
    </div>
    <div class="form-group">
