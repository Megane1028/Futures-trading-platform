<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"../application/index/view/default/home/reg.html";i:1706536486;}*/ ?>
<!DOCTYPE html>
...
<body class="bgWhite">
   ...
   <div class="czmm-account">
       <img src="/template/mb/images/yz.png" class="icon-img">
   ...
   <div class="czmm-pwd">
       <img src="/template/mb/images/pwd.png" class="icon-img">
       <input type="password" placeholder="请输入密码" id="setpassword"  data-localize="safe.ppwd">
       <img src="/template/mb/images/eye_no.png" data-type="0"  class="icon-img" onclick="setHS(this)">
   </div>
   <div class="czmm-pwd">
       <img src="/template/mb/images/pwd.png" class="icon-img">
       <input type="password" placeholder="请再次输入密码" id="verifypassword" data-localize="safe.reppwd">
       <img src="/template/mb/images/eye_no.png" data-type="0"  class="icon-img" onclick="verify(this)">
   </div>
   <div class="czmm-account mb10">
       <img src="/template/mb/images/personal.png" class="icon-img">      
   ...
   <div class="check">
       <div class="check-in" onclick="check(this)" data-type="0">
           <img src="/template/mb/images/check_in.png">
    ...
    <script type="text/javascript" src="/template/mb/javascripts/main.js"></script>
    <script type="text/javascript">
        ...
        function verify(that){
            if($(that).attr('data-type')==0){
                ...
                $(that).attr('src','/template/mb/images/eye.png');
                $("#verifypassword").attr('type','text');
            }else{
                $(that).attr('data-type',0)
                $("#verifypassword").attr('type','password');
                $(that).attr('src','/template/mb/images/eye_no.png');
            }
        }
        function setHS(that){
            if($(that).attr('data-type')==0){
