<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"../application/index/view/default/index/trades.html";i:1706540022;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/template/mb/element-ui/lib/theme-chalk/index.css" />
	<link rel="stylesheet" type="text/css" href="/template/mb/lib/bootstrap.min.css" />
	<link rel="stylesheet" type="text/css" href="/template/mb/css/common.css">
	<link rel="stylesheet" type="text/css" href="/template/mb/lib/kline/kline.css">
	<link rel="stylesheet" type="text/css" href="/template/mb/css/dataMap.css" />
	<link rel="stylesheet" type="text/css" href="/template/mb/css/footer.css" />
	<style>
	    .active{
	        color:#fff !important;
...
<body>
	<div id="app" v-cloak>
	    <div class="tradeConfirm" v-show="tradeConfirmbool">
	        ...
	        <div class="tradeorder-title">
	            ...
	            <img src="/template/mb/images/ia.png" @click="tradeConfirmClick()">
	        </div>
	    ...
	    <div class="tradeorder">
	        <div class="tradeorder-title">
	            <span data-localize="zdy.orderconfirm">订单确认</span>
	            <img src="/template/mb/images/ia.png" @click="tradeOrderClick()">
	        </div>
	        <div class="tradeorder-top tradeorder-bili">
	            <div class="tradeorder-top-list">
		...
		<div id="header">
			...
			<div class='header'>
				<!--<p class="pull-left">-->
				<!--	<img onclick="javascript:history.go(-1);" class="return" src="/template/mb/images/return1.png" alt="">-->
				<!--</p>-->
        ...
        <!--    </div>-->
			<div class="tabs-data-map-box" :style="tradeId?'margin-top:0;border-bottom:1px solid #eee':''">
			    <span class="tabs-data-map" @click="showLeft">
                	...
                	<img src="/template/mb/images/threejiao.png">
                </span>
                <div class="tabs-data-map-box-scan" onclick="window.location.href='<?php echo url('user/orderlist'); ?>'" v-if="tradeId">
                    <img src="/template/mb/images/copy_scan_code.png">
		...
		<div class="order-list" v-show="tradeId">
			...
			<ul class="lists">
				...
				<li
					...
					<p>{{item.open_price || '0.00' | toFixed4}} <img v-if="item.type == 1" width="10" src="/template/mb/images/buy.png" alt="">
						<img v-else width="10" src="/template/mb/images/sell.png" alt=""></p>
		...
		<div id="bottom" class="flex between" v-if="tradeId">
			...
			<!--	</div>-->
			<!--	<div class="logo-down">-->
			<!--		<img src="/template/mb/images/downs.png" alt="">-->
			<!--	</div>-->
			<!--</div>-->
			<div class="flex">
	    ...
	    <footer>
	            <a href="index.html" <?php if($current == 'index'): ?>class="select"<?php endif; ?>>
	                <div>
	                    <p class="img img0"></p>
	            ...
	            <a href="<?php echo url('user/wallet'); ?>"  <?php if($current == 'wallet'): ?>class="select"<?php endif; ?>>
	                <div>
	                    <p class="img img3"></p>
	...
	<script type="text/javascript" src="/template/mb/lib/layer_mobile/layer.js"></script>
	<script type="text/javascript" src="/template/mb/element-ui/lib/index.js"></script>
	<script type="text/javascript" src="/template/mb/javascripts/socket.io.js"></script>
	<script type="text/javascript" src="/template/mb/tradeview/charting_library/charting_library.min.js"></script>
	<script type="text/javascript" src="/template/mb/lib/jquery.localize.min.js"></script>
	<script type="text/javascript" src="/template/mb/lib/language_cookie.js"></script>
	<script type="text/javascript" src="/template/mb/javascripts/main.js?2020"></script>
	<script type="text/javascript" src="/template/mb/javascripts/dataMap.js"></script>
	<script>
		var ATMExQuoteChart = {
			__state: function () {
				this._widget = null;
		...
		var vm = new Vue({
			...
			methods: {
				...
				overrides() {
			     ...
			     //   	$(".tabs-data-map img").attr('src','/template/mb/images/news/threejiao_white.png')
