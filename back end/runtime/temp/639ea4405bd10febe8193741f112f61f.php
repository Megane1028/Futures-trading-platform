<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/www.1.com/public/../application/admin/view/user/credit_score.html";i:1718292233;s:65:"/www/wwwroot/www.1.com/application/admin/view/layout/default.html";i:1718292239;s:62:"/www/wwwroot/www.1.com/application/admin/view/common/meta.html";i:1718292246;s:64:"/www/wwwroot/www.1.com/application/admin/view/common/script.html";i:1718292246;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">当前信誉分:</label>
        <div class="col-xs-12 col-sm-8">
            <input class="form-control" type="number" value="<?php echo htmlentities($row['credit_score']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">操作类型:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-optype" data-rule="required" class="form-control" name="row[optype]">
                <option value="增加信誉分">增加信誉分</option>
                <option value="扣除信誉分">扣除信誉分</option>
            </select>
        </div>
    </div>
    <div class="form-group">
