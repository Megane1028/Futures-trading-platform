<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/www/wwwroot/www.1.com/public/../application/admin/view/user/score.html";i:1718954806;s:65:"/www/wwwroot/www.1.com/application/admin/view/layout/default.html";i:1718292239;s:62:"/www/wwwroot/www.1.com/application/admin/view/common/meta.html";i:1718292246;s:64:"/www/wwwroot/www.1.com/application/admin/view/common/script.html";i:1718292246;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-money" data-rule="required" class="form-control" step="0.01" name="row[money]" type="number" value="<?php echo htmlentities($row['money']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">操作类型:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-optype" data-rule="required" class="form-control selectpicker" name="row[optype]">
                <option value="网银入金">网银入金</option>
                <option value="网银出金">网银出金</option>
                <option value="赠送积分">赠送积分</option>
                <option value="系统存入">系统存入</option>
            </select>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">变更备注:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-agent" class="form-control" name="row[remark]" type="text" value="">
        </div>
    </div>
